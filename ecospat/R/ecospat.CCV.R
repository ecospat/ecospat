...
assign("community.metrics.cali.selected",NULL, envir = .GlobalEnv)
assign("community.metrics.eval.selected",NULL, envir = .GlobalEnv)
assign("output",NULL, envir = .GlobalEnv)
